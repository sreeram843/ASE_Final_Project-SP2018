...
public class BaseData {
    ...
    {        
        ...
        public DataClass(DataClass datumSrc) throws ErrProcessor.JFCALCExpErrException {
            // initial data class by deep copy it from another dataclass
            copyTypeValueDeep(datumSrc);
        }
        
        public DataClass(DATATYPES enumDataType, MFPNumeric mfpNumDataValue) throws ErrProcessor.JFCALCExpErrException {
        ...
        public DataClass(DATATYPES enumDataType, String str) throws ErrProcessor.JFCALCExpErrException {
        ...
        public DataClass(DataClass[] dataList) throws ErrProcessor.JFCALCExpErrException {
            // initialize function or string data class
            if (dataList == null)    {
        ...
        public DataClass(AbstractExpr aexpr) throws ErrProcessor.JFCALCExpErrException {
        ...
        public final void setDataClass(DATATYPES enumDataType, MFPNumeric mfpNumDataValue, String strValue, 
                  String strFuncName, DataClass[] dataList, AbstractExpr aexpr, String strUsrDefType) throws ErrProcessor.JFCALCExpErrException {
        ...
        public void setDataValue(MFPNumeric mfpNumDataValue, DATATYPES enumDataType) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = mfpNumDataValue;
            menumDataType = enumDataType;
            validateDataClass();    
        }
        public void setDataValue(MFPNumeric mfpNumDataValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = mfpNumDataValue;
            menumDataType = DATATYPES.DATUM_DOUBLE;
            validateDataClass();    
        }
        public void setDataValue(boolean bValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = bValue?MFPNumeric.TRUE:MFPNumeric.FALSE;
            menumDataType = DATATYPES.DATUM_BOOLEAN;
            validateDataClass();    
        }
        public void setDataValue(byte nValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = new MFPNumeric((long)nValue);
            menumDataType = DATATYPES.DATUM_INTEGER;
            validateDataClass();    
        }
        public void setDataValue(short nValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = new MFPNumeric((long)nValue);
            menumDataType = DATATYPES.DATUM_INTEGER;
            validateDataClass();    
        }
        public void setDataValue(int nValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = new MFPNumeric((long)nValue);
            menumDataType = DATATYPES.DATUM_INTEGER;
            validateDataClass();    
        }
        public void setDataValue(long nValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = new MFPNumeric(nValue);
            menumDataType = DATATYPES.DATUM_INTEGER;
            validateDataClass();    
        }
        public void setDataValue(float fValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = new MFPNumeric((double)fValue);
            menumDataType = DATATYPES.DATUM_DOUBLE;
            validateDataClass();    
        }
        public void setDataValue(double dValue) throws ErrProcessor.JFCALCExpErrException {
            mmfpNumDataValue = new MFPNumeric(dValue);
            menumDataType = DATATYPES.DATUM_DOUBLE;
            validateDataClass();    
        }
        
        public void setStringValue(String strValue) throws ErrProcessor.JFCALCExpErrException {
            mstrValue = strValue;
            menumDataType = DATATYPES.DATUM_STRING;
            validateDataClass();    
        }
        public void setFunctionName(String strFunctionName) throws ErrProcessor.JFCALCExpErrException {
            mstrFunctionName = strFunctionName;
            menumDataType = DATATYPES.DATUM_REF_FUNC;
            validateDataClass();    
        }
        public void setDataList(DataClass[] dataList, DATATYPES enumDataType) throws ErrProcessor.JFCALCExpErrException {
            DATATYPES enumDataTypeOld = menumDataType;
            MFPNumeric mfpNumDataValueOld = mmfpNumDataValue;
            String strValueOld = mstrValue;
            String strFunctionNameOld = mstrFunctionName;
        ...
        public void setDataList(DataClass[] dataList) throws ErrProcessor.JFCALCExpErrException {
            DATATYPES enumDataTypeOld = menumDataType;
            MFPNumeric mfpNumDataValueOld = mmfpNumDataValue;
            String strValueOld = mstrValue;
            String strFunctionNameOld = mstrFunctionName;
        ...
        public void setAExpr(AbstractExpr aexpr) throws ErrProcessor.JFCALCExpErrException {
            maexpr = aexpr;
        ...
        public void setComplex(DataClass datumComplex) throws ErrProcessor.JFCALCExpErrException {
        ...
        public void setComplex(DataClass datumReal, DataClass datumImage) throws ErrProcessor.JFCALCExpErrException {
            menumDataType = DATATYPES.DATUM_COMPLEX;
        ...
        public void setComplex(MFPNumeric mfpNumReal, MFPNumeric mfpNumImage) throws ErrProcessor.JFCALCExpErrException {
            menumDataType = DATATYPES.DATUM_COMPLEX;
            mdataList = new DataClass[2];
        ...
        public void setComplexRadAngle(MFPNumeric mfpNumRad, MFPNumeric mfpNumAngle) throws ErrProcessor.JFCALCExpErrException {
            menumDataType = DATATYPES.DATUM_COMPLEX;
        ...
        public void setReal(DataClass datumReal) throws ErrProcessor.JFCALCExpErrException {
            setComplex(datumReal, getImageDataClass());
        }
        public void setReal(MFPNumeric mfpNumReal) throws ErrProcessor.JFCALCExpErrException {
            setComplex(mfpNumReal, getImage());
        }
        public void setImage(DataClass datumImage) throws ErrProcessor.JFCALCExpErrException {
            setComplex(getRealDataClass(), datumImage);
        }
        public void setImage(MFPNumeric mfpNumImage) throws ErrProcessor.JFCALCExpErrException {
         ...
         */
        public void allocDataArray(int[] nListArraySize, DataClass datumDefault) throws ErrProcessor.JFCALCExpErrException {
        ...
        public void populateDataArray(int[] narrayDims, boolean bCvtNull2Zero) throws ErrProcessor.JFCALCExpErrException {
        ...
        public DataClass getDataAtIndexByRef(int[] indexList) throws ErrProcessor.JFCALCExpErrException {
        ...
        public DataClass getDataAtIndex(int[] indexList) throws ErrProcessor.JFCALCExpErrException {
        ...
        public void setDataAtIndexByRef(int[] indexList, DataClass datum) throws ErrProcessor.JFCALCExpErrException {
            DataClass datumCurrent = this;
            for (int nIndex = 0; nIndex < indexList.length; nIndex ++)    {
                if (indexList[nIndex] < 0)    {
                    throw new ErrProcessor.JFCALCExpErrException(ErrProcessor.ERRORTYPES.ERROR_WRONG_INDEX);
        ...
        public void setDataAtIndex(int[] indexList, DataClass datum) throws ErrProcessor.JFCALCExpErrException {
        ...
        public DataClass obtainDataAtIndexByRef(int[] indexList, DataClass datumDefault) throws ErrProcessor.JFCALCExpErrException {
            for (int nIndex = 0; nIndex < indexList.length; nIndex ++)    {
                if (indexList[nIndex] < 0)    {
                    throw new ErrProcessor.JFCALCExpErrException(ErrProcessor.ERRORTYPES.ERROR_WRONG_INDEX);
                }
        ...
        // data if the array index is beyond its range.
        public DataClass obtainDataAtIndex(int[] indexList, DataClass datumDefault) throws ErrProcessor.JFCALCExpErrException {
            DataClass datumReturn = new DataClass();
        ...
        public void createDataAtIndexByRef(int[] indexList, DataClass datum, DataClass datumNewByDefault) throws ErrProcessor.JFCALCExpErrException {
            for (int nIndex = 0; nIndex < indexList.length; nIndex ++)    {
                if (indexList[nIndex] < 0)    {
                    throw new ErrProcessor.JFCALCExpErrException(ErrProcessor.ERRORTYPES.ERROR_WRONG_INDEX);
                }
        ...
        // if the array index is beyond its range.
        public void createDataAtIndex(int[] indexList, DataClass datum, DataClass datumNewByDefault) throws ErrProcessor.JFCALCExpErrException {
            DataClass datumParam = new DataClass();
            datumParam.copyTypeValue(datum);
        ...
        // change data type
        public boolean changeDataType(DATATYPES enumNewDataType) throws ErrProcessor.JFCALCExpErrException
        {
        ...
        public boolean isEqual(DataClass datum, double errorScale) throws ErrProcessor.JFCALCExpErrException
        {
            if (errorScale < 0)    {
        ...
        public boolean isZeros(boolean bExplicitNullIsZero) throws ErrProcessor.JFCALCExpErrException {
            if (menumDataType == DATATYPES.DATUM_NULL)    {
        ...
        public void setAllLeafChildren(DataClass datumValue) throws ErrProcessor.JFCALCExpErrException {
            if (menumDataType != DATATYPES.DATUM_REF_DATA)    {
        ...
        public boolean isEye(boolean bExplicitNullIsZero) throws ErrProcessor.JFCALCExpErrException {
        ...
        public void copyTypeValue(DataClass datumSrc) throws ErrProcessor.JFCALCExpErrException
        {
        ...
        public final void copyTypeValueDeep(DataClass datumSrc) throws ErrProcessor.JFCALCExpErrException
        {
