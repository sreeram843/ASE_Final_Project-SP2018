...
public class MathLib {
    public static LinkedList<DataClass> solvePolynomial(LinkedList<DataClass> listParams, FunctionInterrupter functionInterrupter) throws ErrProcessor.JFCALCExpErrException, InterruptedException    {
    ...
    public static int[][] getPermutations(int n, LinkedList<Long> listReversedPairCnts, FunctionInterrupter functionInterrupter) throws ErrProcessor.JFCALCExpErrException, InterruptedException   {
        if (functionInterrupter != null)    {
            // for debug or killing a background thread. Every heavy functions need to have this check.
            if (functionInterrupter.shouldInterrupt())    {
                functionInterrupter.interrupt();
    ...
    public static DataClass[] multiplyPolynomial(DataClass[] datumParams1, DataClass[] datumParams2, FunctionInterrupter functionInterrupter)  throws ErrProcessor.JFCALCExpErrException, InterruptedException   {
        if (functionInterrupter != null)    {
            // for debug or killing a background thread. Every heavy functions need to have this check.
            if (functionInterrupter.shouldInterrupt())    {
                functionInterrupter.interrupt();
    ...
    public static DataClass[] addSubPolynomial(DataClass[] datumParams1, DataClass[] datumParams2, boolean bIsAdd, FunctionInterrupter functionInterrupter)  throws ErrProcessor.JFCALCExpErrException, InterruptedException   {
        if (functionInterrupter != null)    {
            // for debug or killing a background thread. Every heavy functions need to have this check.
            if (functionInterrupter.shouldInterrupt())    {
                functionInterrupter.interrupt();
    ...
    public static DataClass getLimValue(DataClass[] datumArrayXs, DataClass[] datumArrayF_Xs, DataClass datumX0, DataClass datumF_X0) throws ErrProcessor.JFCALCExpErrException {
    ...
    public static DataClass[] integByGaussKronrod(AbstractExpr aeStrExpr/*String strIntegExpr*/, String strVariable, DataClass datumFrom, DataClass datumTo,
            ...
            LinkedList<LinkedList<Variable>> lVarNameSpaces, FunctionInterrupter functionInterrupter) throws ErrProcessor.JFCALCExpErrException, InterruptedException {
        ...
        if (bCheckConverge && bNotConvergeExit) {
            throw new ErrProcessor.JFCALCExpErrException(ErrProcessor.ERRORTYPES.ERROR_CALCULATION_CANNOT_CONVERGE); // not converge like 1/x from -inf to inf
        }
        if (bExceptNotEnoughSteps && bNotEnoughStepsExit) {
            throw new ErrProcessor.JFCALCExpErrException(ErrProcessor.ERRORTYPES.ERROR_CALCULATION_CANNOT_CONVERGE); // the calculation steps are not enough to see a converged result.
        }
        if (bCheckFinalResult && (mfpQAbs.isNan() || datumErr.getDataValue().isNan()  //we can still get Nan when cvtvar is very close to 1.
            ...
            throw new ErrProcessor.JFCALCExpErrException(ErrProcessor.ERRORTYPES.ERROR_CALCULATION_CANNOT_CONVERGE);
        }
    ...
    protected static void initGaussKronrodSubRanges(double dFrom, double dTo, DataClass[] darraySubs) throws ErrProcessor.JFCALCExpErrException {
    ...
    protected static DataClass[][] integByGaussKronrodCore(AbstractExpr aeStrExpr/*String strIntegExpr*/,
                                                        ...
                                                        ) throws ErrProcessor.JFCALCExpErrException, InterruptedException {
    ...
    protected static DataClass integGKTransFInf2Inf(DataClass datumCvtVar, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
    ...
    // this function will not change its parameters and its returned value does not refer to any part of its parameters
    protected static DataClass integGKExprFInf2Inf(DataClass datumCvtVar, DataClass datumInteg, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
    ...
    // this function will not change its parameters and its returned value does not refer to any part of its parameters
    protected static DataClass integGKTransFFromInf(DataClass datumCvtVar, DataClass datumTo, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
    ...
    // this function will not change its parameters and its returned value does not refer to any part of its parameters
    protected static DataClass integGKExprFFromInf(DataClass datumCvtVar, DataClass datumInteg, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
    ...
    // this function will not change its parameters and its returned value does not refer to any part of its parameters
    protected static DataClass integGKTransFToInf(DataClass datumCvtVar, DataClass datumFrom, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
    ...
    // this function will not change its parameters and its returned value does not refer to any part of its parameters
    protected static DataClass integGKExprFToInf(DataClass datumCvtVar, DataClass datumInteg, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
        // if bImage is true, then 2i * cvtvar * integ / (1 - cvtvar)**3 ----------> i * integ * 2 * cvtvar/ (1 - cvtvar)**3
        // else 2 * cvtvar * integ / (1 - cvtvar)**3 ------------> integ * 2 * cvtvar/ (1 - cvtvar)**3, here cvtvar must be a real value.
        MFPNumeric mfpNumCvtVar = datumCvtVar.getReal();
    ...
    // this function will not change its parameters and its returned value does not refer to any part of its parameters
    protected static DataClass integGKTransFGeneral(DataClass datumCvtVar, DataClass datumFrom, DataClass datumTo, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
        if (bImage) {
    ...
    // this function will not change its parameters and its returned value does not refer to any part of its parameters
    protected static DataClass integGKExprFGeneral(DataClass datumCvtVar, DataClass datumInteg, DataClass datumFrom, DataClass datumTo, boolean bImage) throws ErrProcessor.JFCALCExpErrException {
        if (bImage) {
    ...
    protected static DataClass integGKTransF(DataClass datumCvtVar, DataClass datumFrom, DataClass datumTo, int nIntegMode) throws ErrProcessor.JFCALCExpErrException {
        switch(nIntegMode) {
            case 1:
    ...
    protected static DataClass integGKExprF(DataClass datumCvtVar, DataClass datumInteg, DataClass datumFrom, DataClass datumTo, int nIntegMode) throws ErrProcessor.JFCALCExpErrException {
        switch(nIntegMode) {
            case 1:
