...
public class PtnSlvMultiVarsIdentifierMgr {   // have to be thread safe.
    ...
    public static PtnSlvMultiVarsIdentifier createIntPowPtnSlvMultiVarsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		PtnSlvMultiVarsIdentifier.PatternSetByString[] pssArray = new PtnSlvMultiVarsIdentifier.PatternSetByString[1];
		pssArray[0] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		paIntPow.setPtnSlvMultiVarsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_SINGLEVARINTPOW,
	...
	public static PtnSlvMultiVarsIdentifier createPolynomialPtnSlvMultiVarsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		paPolynomial.setPtnSlvMultiVarsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_SINGLEVARPOLYNORMIAL,
				pssArray, strarrayVars, narrayVarOrders, strarraySolveVarExprs, barrayRootsList);
		return paPolynomial;
	}
	...
	public static PtnSlvMultiVarsIdentifier create1stOrderEqs2VarsPtnSlvMultiVarsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		PtnSlvMultiVarsIdentifier.PatternSetByString[] pssArray = new PtnSlvMultiVarsIdentifier.PatternSetByString[2];
		pssArray[0] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pssArray[1] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pa1stOrderEqs2Vars.setPtnSlvMultiVarsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_FIRSTORDER2VAREQUATIONS,
				pssArray, strarrayVars, narrayVarOrders, strarraySolveVarExprs, barrayRootsList);
	...
	public static PtnSlvMultiVarsIdentifier create1stOrderEqs3VarsPtnSlvMultiVarsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		PtnSlvMultiVarsIdentifier.PatternSetByString[] pssArray = new PtnSlvMultiVarsIdentifier.PatternSetByString[3];
		pssArray[0] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pssArray[2] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pa1stOrderEqs3Vars.setPtnSlvMultiVarsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_FIRSTORDER3VAREQUATIONS,
				pssArray, strarrayVars, narrayVarOrders, strarraySolveVarExprs, barrayRootsList);
	...
	public static PtnSlvMultiVarsIdentifier create1stOrderEqs4VarsPtnSlvMultiVarsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		PtnSlvMultiVarsIdentifier.PatternSetByString[] pssArray = new PtnSlvMultiVarsIdentifier.PatternSetByString[4];
		pssArray[0] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pssArray[3] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pa1stOrderEqs4Vars.setPtnSlvMultiVarsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_FIRSTORDER4VAREQUATIONS,
				pssArray, strarrayVars, narrayVarOrders, strarraySolveVarExprs, barrayRootsList);
	...
	public static PtnSlvMultiVarsIdentifier create1stOrderEqs5VarsPtnSlvMultiVarsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		PtnSlvMultiVarsIdentifier.PatternSetByString[] pssArray = new PtnSlvMultiVarsIdentifier.PatternSetByString[5];
		pssArray[0] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pssArray[4] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pa1stOrderEqs5Vars.setPtnSlvMultiVarsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_FIRSTORDER5VAREQUATIONS,
				pssArray, strarrayVars, narrayVarOrders, strarraySolveVarExprs, barrayRootsList);
	...
	public static PtnSlvMultiVarsIdentifier create1stOrderEqs6VarsPtnSlvMultiVarsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		PtnSlvMultiVarsIdentifier.PatternSetByString[] pssArray = new PtnSlvMultiVarsIdentifier.PatternSetByString[6];
		pssArray[0] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pssArray[5] = new PtnSlvMultiVarsIdentifier.PatternSetByString();
		...
		pa1stOrderEqs6Vars.setPtnSlvMultiVarsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_FIRSTORDER6VAREQUATIONS,
				pssArray, strarrayVars, narrayVarOrders, strarraySolveVarExprs, barrayRootsList);
