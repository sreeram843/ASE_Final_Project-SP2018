...
public class SMElemAnalyzer extends ElemAnalyzer {
	...
	public AbstractExpr getNumberAExpr(String strExpression, CurPos curpos) throws ErrProcessor.JFCALCExpErrException, JSmartMathErrException
	{
	...
	public AbstractExpr getDataRefAExpr(String strExpression, CurPos curpos, LinkedList<Variable> listPseudoConsts) throws ErrProcessor.JFCALCExpErrException, InterruptedException, JSmartMathErrException
	{
	 ...
	 * @throws InterruptedException 
	 * @throws JSmartMathErrException ***************************************************************************/
	public AbstractExpr getExprNameAExpr(String strExpression, CurPos curpos, LinkedList<Variable> listPseudoConsts) throws ErrProcessor.JFCALCExpErrException, InterruptedException, JSmartMathErrException
	{
	...
	\
	 * @throws ErrProcessor.JFCALCExpErrException, JSmartMathErrException ***************************************************************************/
	public AbstractExpr getStringAExpr(String strExpression, CurPos curpos) throws ErrProcessor.JFCALCExpErrException, JSmartMathErrException
	{
