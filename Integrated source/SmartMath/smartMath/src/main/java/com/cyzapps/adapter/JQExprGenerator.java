...
public class JQExprGenerator	{
	...
	public static String convertTwoOperandCell(String strFirstOperand,
                                               BaseData.CalculateOperator COPTROperator, String strSecondOperand) {
	...
	public static String convertOneOperandCell(String strOperand, BaseData.CalculateOperator COPTROperator) {
		BaseData.OPERATORTYPES enumOperatorType = COPTROperator.getOperatorType();
		String strOpt = "";
	...
	public static String convertOneOperandCell(BaseData.CalculateOperator COPTROperator, String strOperand) {
		BaseData.OPERATORTYPES enumOperatorType = COPTROperator.getOperatorType();
		String strOpt = "";
    ...
    public static String cvtExpr2JQMath(String strExpression, BaseData.CurPos curpos) {
        LinkedList<String> listValues = new LinkedList<String>();
		LinkedList<BaseData.CalculateOperator> listCalcOpts = new LinkedList<BaseData.CalculateOperator>();
