...
public class AEIndex extends AbstractExpr {
    ...
    public AEIndex(AbstractExpr aexprOrigin) throws ErrProcessor.JFCALCExpErrException, JSmartMathErrException    {
        copy(aexprOrigin);
    }
	...
	@Override
	public AbstractExpr replaceChildren(LinkedList<PatternExprUnitMap> listFromToMap, boolean bExpr2Pattern, LinkedList<AbstractExpr> listReplacedChildren) throws ErrProcessor.JFCALCExpErrException, JSmartMathErrException	{
		AEIndex aeReturn = new AEIndex();
        aeReturn.copy(this);
	...
	@Override
	public AbstractExpr distributeAExpr(SimplifyParams simplifyParams) throws ErrProcessor.JFCALCExpErrException,
			JSmartMathErrException {
		validateAbstractExpr();
	...
	public static AbstractExpr mergeIndex(AbstractExpr aeBase, AbstractExpr aeIndex) throws ErrProcessor.JFCALCExpErrException, JSmartMathErrException	{
		if (aeBase instanceof AEConst && aeIndex instanceof AEConst)	{
			// this dataclass has been validated, it must be a data reference
