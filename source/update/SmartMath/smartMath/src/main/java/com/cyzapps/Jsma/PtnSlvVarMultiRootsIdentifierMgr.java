...
public class PtnSlvVarMultiRootsIdentifierMgr {   // have to be thread safe.
    ...
    public static PtnSlvVarMultiRootsIdentifier createPosIntPowPtnSlvVarMultiRootsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		PtnSlvVarMultiRootsIdentifier.PatternSetByString pss = new PtnSlvVarMultiRootsIdentifier.PatternSetByString();
		...
		paIntPow.setPtnSlvVarMultiRootsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_SINGLEVARPOSINTPOW, pss, strVariable, strSolveVarExpr, strRootNumber);
		return paIntPow;
    }
    ...
    public static PtnSlvVarMultiRootsIdentifier createNegIntPowPtnSlvVarMultiRootsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		paIntPow.setPtnSlvVarMultiRootsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_SINGLEVARNEGINTPOW, pss, strVariable, strSolveVarExpr, strRootNumber);
		return paIntPow;
    }
	...
	public static PtnSlvVarMultiRootsIdentifier create3OrderPolynomialPtnSlvVarMultiRootsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		paPolynomial.setPtnSlvVarMultiRootsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_SINGLEVAR3ORDERPOLYNORMIAL, pss, strVariable, strSolveVarExpr, strRootNumber);
		return paPolynomial;
	}
	...
	public static PtnSlvVarMultiRootsIdentifier create6OrderPolynomialPtnSlvVarMultiRootsIdentifier() throws SMErrProcessor.JSmartMathErrException, ErrProcessor.JFCALCExpErrException, InterruptedException	{
		...
		paPolynomial.setPtnSlvVarMultiRootsIdentifier(PatternManager.ABSTRACTEXPRPATTERNS.AEP_SINGLEVAR6ORDERPOLYNORMIAL, pss, strVariable, strSolveVarExpr, strRootNumber);
		return paPolynomial;
	}
}
