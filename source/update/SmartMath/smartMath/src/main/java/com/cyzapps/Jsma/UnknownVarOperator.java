...
public class UnknownVarOperator {
	public static class UnknownVariable	extends Variable {
		...
		public UnknownVariable(String strName, BaseData.DataClass datumValue)	{
		...
		public BaseData.DataClass getSolvedValue() throws JSmartMathErrException	{
			if (!mbValueAssigned) {
		...
		public BaseData.DataClass setValue(BaseData.DataClass datum)	{
	...
	public static BaseData.DataClass lookUpList4Value(String strName, LinkedList<UnknownVariable> lUnknownVars) throws JSmartMathErrException	{
    ...
    public static LinkedList<UnknownVariable> cloneUnknownVarList(LinkedList<UnknownVariable> listUnknownVars) throws ErrProcessor.JFCALCExpErrException {
